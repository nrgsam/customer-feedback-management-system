...
$q = "SELECT * FROM `satisfaction4` ORDER BY `id` DESC LIMIT 1";
$res = mysqli_query($link, $q);
$row = mysqli_fetch_array($res);
echo ($row['id']);
$time = date("Y-m-d H:i:s");
$q3 = " UPDATE `satisfaction4` SET `name`='$fname',`lastname`='$lname',`position`='$position',`comany`='$company',`prodouctname`='$product'
    ,`q1`='$q1',`q1_score`='$s1',`q1_important`='$d1',`q2`='$q2',`q2_score`='$s2',`q2_important`='$d2',`q3`='$q3',`q3_score`='$s3',`q_important3`='$d3',`q4`='$q4' ,`q_score4`='$s4',`q_important4`='$d4',`q5`='$q5',`q_score5`='$s5',`q_important5`='$d5',`q6`='$q6',`q_score6`='$s6',`q_important6`='$d6',`q7`='$q7',`q_score7`='$s7',`q_important7`='$d7',`q8`='$q8',`q_score8`='$s8',`q_important8`='$d8',`tel`='$tel',`end_date`='$time',`date`='$date', `serial`='$newserial' WHERE id=$row[id] ";
